      ...
      <div className="w-full max-w-md space-y-6 bg-white p-6 rounded-lg shadow-md">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="h-5 w-5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="h-5 w-5">
            <path fill="#4285F4" d="M24 9.5c3.29 0 6.24 1.13 8.57 3.36l6.38-6.38C34.6 2.61 29.6.5 24 .5 14.98.5 7.47 6.62 4.59 14.88l7.57 5.88C13.31 14.45 18.3 9.5 24 9.5z"/>
            ...
            <path fill="#EA4335" d="M46.1 24.5c0-1.6-.14-3.1-.4-4.5H24v9h12.6c-.5 2.6-2 4.8-4.1 6.3l6.5 5.1c3.8-3.4 6.1-8.5 6.1-15z"/>
            </svg>
          </svg>
          <span className="text-sm text-gray-700 font-medium">Login dengan Google</span>
        </button>
